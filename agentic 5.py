...
Apply adjustments smoothly and proportionally to reflect the strength of financial and stock information in the narrative and the financial context. Return a single integer between 0 and 100 as the final adjusted risk score.
 """,
    # add_context_instructions = ""
    # use_tools=True,
    show_tool_calls=True,
